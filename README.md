...
# KantumID
> Kantum is an open-source health data management system based on the Linia Protcol and Ethereum.
...
## Prerequisites
  ...
  * [Uport Mobile App](https://uport.me)
  [iOS](https://itunes.apple.com/us/app/uport-identity-wallet-ethereum/id1123434510?mt=8) || [Android](https://play.google.com/store/apps/details?id=com.uportMobile)
...
#https
git clone https://gitlab.com/ahmb84/mobileAppKantumID.git
#ssh
git clone git@gitlab.com:ahmb84/mobileAppKantumID.git
...
# Build uPort for react-native
npm run build-uport-connect

# Run the app on android
react-native run-android

# Run the app on iOS // You need macOS
npm run ios-open
After you can build and launch the app on device connected with the uPort app installed on it.
```

## License
Kantum is licensed under the GNU Affero General Public License v3.0
